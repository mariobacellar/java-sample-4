package com.accenture.xmlmanager.gui;
...
public class RolePlayer extends Application {
	...
	public TextField txtCharacter;
	public TextField txtActor;
	...
	public void start(Stage primaryStage){
		...
		Label 
		lblCharacter = new Label("Character's Name:");
		...
		Label 
		lblActor = new Label("Actor's Name:");
		...
		HBox 
		paneCharacter = new HBox(20, lblCharacter, txtCharacter);
		paneCharacter.setPadding(new Insets(10));

		// Create the Actor pane
		HBox 
		paneActor = new HBox(20, lblActor, txtActor);
		paneActor.setPadding(new Insets(10));

		// Create the Role pane
		HBox 
		paneRole = new HBox(lblRole1, lblRole2, lblRole3, lblRole4);
